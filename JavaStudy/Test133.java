...
public class Test133
{
	public static void main(String[] args)
	{
		...
		System.out.println(sb3);									//--==>> (아무것도안나옴)
		...
		System.out.println(sb3.toString().toUpperCase());			//--==>> SEOULKOREA우리나라대한민국
		...
		//    『한국』이라는 문자열 추가
		sb3.insert(0,"한국");
		System.out.println("seoul 앞에 『한국』추가 :"+sb3);		//--==>> seoul 앞에 『한국』추가 :한국seoulkorea우리나라대한민국
		...
		System.out.println(sb3);									//--==>> 한국seoul사랑korea우리나라대한민국
		...
		// ○ 대상 문자열(sb3)에서
		//    『korea』부터 이후 문자열 삭제 (korea 포함)

		sb3.delete(sb3.indexOf("korea"),sb3.length());
		System.out.println(sb3);									//--==>> 한국seoul사랑
		
		// ○ 대상 문자열(sb3)에서
		//    『사랑』 부터 문자열 삭제 (사랑 포함)
		sb3.delete(sb3.indexOf("사랑"),sb3.length());
		System.out.println(sb3);									//--==>> 한국seoul
		...
		// 문자열(sb3)의 길이 확인
		System.out.println("문자열의 길이 : "+sb3.length());		//--==>> 7
