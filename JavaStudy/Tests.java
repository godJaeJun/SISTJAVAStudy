...
public class Tests
{
	...
	{
		System.out.println( "\u001b[31m test" );         System.out.println(  ANSI_GREEN_BACKGROUND + "This text has a green background but default text!" + ANSI_RESET );         System.out.println(  ANSI_YELLOW + "This text has yellow text but a default background!" + ANSI_RESET );         System.out.println( ANSI_BLUE + "This text has blue text but a default background!" + ANSI_RESET );         System.out.println( ANSI_CYAN + "This text has cyan text but a default background!" + ANSI_RESET );         System.out.println( ANSI_BLACK + "This text has black text but a default background!" + ANSI_RESET );         System.out.println( ANSI_RED + "This text has red text but a default background!" + ANSI_RESET );         System.out.println( ANSI_GREEN_BACKGROUND + ANSI_RED + "This text has a green background and red text!" + ANSI_RESET );         System.out.println( yellow("This text has yellow text but a default background!") );
