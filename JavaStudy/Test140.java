...
○ java.lang.Math 클래스의 주요 상수 및 메소드
   ...
   - public static double sqrt(double a)	--사용
     : a 의 제곱근을 구하여 반환한다.
  
   - public static double ceil(double a)
     : a 보다 크거나 같은 정수를 실수 형태를 반환한다. (올림의 개념)
...
public class Test140
{
	public static void main(String[] args)
	{
		...
		//--==>> 0.0 ~ 1.0 사이의 난수 : 0.4381621317696359
		//		 0.0 ~ 1.0 사이의 난수 : 0.9834018261540469
		//		 0.0 ~ 1.0 사이의 난수 : 0.3438436663645448
		//		 0.0 ~ 1.0 사이의 난수 : 0.5047532979235878
	}
}
// 실행결과
/*
